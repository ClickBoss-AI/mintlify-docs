...
description: "Welcome to ClickBoss Documentation"
---

<iframe src="https://www.youtube.com/embed/cewW0feAgTk" title="YouTube video player" frameborder="0" className="w-full aspect-video rounded-xl" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen />
