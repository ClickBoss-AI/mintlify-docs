...
description: "How to find and run a ClickBoss playbook against your live marketing data, read the results, and save investigations as reusable playbooks."
keywords: ["run playbook", "playbook results", "marketing analysis", "save as playbook"]
---
